...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2017 at 09:17 AM
...
(6, 'Amit', '8097204164', 'amit001bauriya@gmail.com', 'Hello test msg'),
(7, ' Name', '8082627948', 'Hhahha@hham.com', 'aasdsd'),
(8, ' Name', '8082627948', 'Hhahha@hham.com', 'aasdsd'),
(9, 'Amit', '8082627948', 'amit@hh.com', 'asasas'),
(10, 'aa', '8082627948', 'amit@hh.com', 'aaxaxx'),
(11, 'aa', '8082627948', 'amit@hh.com', 'aaxaxx');
...
(10, 11, 'Shavir', 'Male', '9915510777', 'shavirpaul@gmail.com', 6, 1, 2, 'We have read about the interest your advertisement in the times of India about the vacation trip. We will appreciate, if you kindly send the detailed information about the cost of the trip,the luggage wight, economy class and first class and etc. . The above information is required for our managing director who will like to enjoy the holiday trip along with his family.', 'Booked'),
...
(13, 2, 'Amit Bauriya', 'Male', '8097204164', 'bauriyaabhishek@gmail.com', 5, 2, 1, 'Hellloo', 'Pending');

-- --------------------------------------------------------

--
-- Table structure for table `horizontal_frag`
--

CREATE TABLE `horizontal_frag` (
  `Subcatid` int(200) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `horizontal_frag`
--

INSERT INTO `horizontal_frag` (`Subcatid`, `Subcatname`, `Catid`, `Pic`, `Detail`) VALUES
...
--
-- Table structure for table `horizontal_frag_2`
--

CREATE TABLE `horizontal_frag_2` (
  `Packid` int(200) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `horizontal_frag_2`
--

INSERT INTO `horizontal_frag_2` (`Packid`, `Packname`, `Category`, `Subcategory`, `Packprice`, `Pic1`, `Pic2`, `Pic3`, `Detail`) VALUES
...
(4, 'Family holiday in Dubai', 1, '131.jpg', 'This is a real family adventure taking in every face of Dubai - premium lavish life, national parks, rainforest and beaches - all held together by great organisation and excellent guides.'),
...
--
-- Table structure for table `vertical_frag_1`
--

CREATE TABLE `vertical_frag_1` (
  `Packid` int(200) NOT NULL DEFAULT '0',
  `Packname` varchar(1000) NOT NULL,
  `Packprice` int(200) NOT NULL,
  `Detail` varchar(8000) NOT NULL
...
--
-- Dumping data for table `vertical_frag_1`
--

INSERT INTO `vertical_frag_1` (`Packid`, `Packname`, `Packprice`, `Detail`) VALUES
(1, 'Christmas Adventure in Lapaland     ', 20000, 'What better way to celebrate Christmas than to spend it where Santa Claus lives? Come experience a traditional Lapland Christmas in Finland: meet Santa in person at the world-famous Santa Claus Village, enjoy the thrill of a dog sled ride and learn about the unique Sami culture at a reindeer farm. This magical holiday will surely create lasting memories for the entire family.'),
(2, 'Agra Family Tour ', 10000, 'A fun-filled holiday with your family is the best time to strengthen bonds and rejuvenate the love between dear ones. And, what could be a better place to have a good time with your family members than Agra? The pleasant weather, beautiful sceneries and delightful food is sure to put you in your best mood to revel the best time with your family. For a stress-free vacation, you can explore your options for Agra family holidays packages with us on Yatra.com. From hotel bookings to travel tickets, we offer various services to help you enjoy your Agra family tour packages. Visit the numerous attractions of this beautiful place in the company of your loved ones with our Agra family vacation and tour packages away from the routine tasks of life. '),
(3, 'Holidays in Italy  ', 20000, 'Enjoy golden beaches, sparkling seas, beautiful countryside, exciting cities and great cuisine on family holidays in Italy. Whether you are looking for an activity based holiday or one full of cultural pursuits, let our experience and insider knowledge help you tailor the ideal Italy family holiday.'),
(4, 'Main attraction in Thailand', 400000, 'Fascinating cultures, a nation that adores children, beautiful beaches in world famous resorts and a well-trodden tourist trail all combine to make Thailand family holidays popular with those looking for a combination of relaxation and adventure. Children can enjoy an invaluable experience discovering new cultures, customs and religions whilst visiting temples alongside having a huge amount of fun when exploring cities, towns and villages and of course in-resort.'),
(5, 'Holidays in Vancouver ', 400000, ' The lakes and mountains of Jasper, Banff and Yoho National Parks, provide the perfect backdrop for hiking and biking, while walking along the massive Athabasca Glacier feels like you are on top of the world. Horse riding, white water rafting, canoeing and whale watching are readily available for the adventurous traveller on our holidays to Canada. '),
(6, 'Haridwar', 3000, 'Haridwar means the ''Gateway to the abode of the gods''. Legend has it, that Prince Bhagirath, through his penance, caused the river Ganges to come down to plains from the Himalayas so that his ancestors who had perished due to a curse of a sage could be revived. '),
(7, 'Tivoli', 500000, 'Villa d''Este, in the town of Tivoli east of Rome, is a beautiful garden and palace complex that''s listed on UNESCO''s World Heritage List. The villa was built in 1560 and was the vision of Cardinal Ippolito II d''Este (who narrowly failed to become a pope). The villa is famous for its magnificent garden of grottoes, fountains, nymphs and water sculpture. Cardinal d''Este died in 1572. By then the work on the garden and the interior painting of the villa was mostly complete'),
(8, 'Austria Trip', 300000, 'Austria is a land of craggy Alps and elaborate baroque buildings. Visitors flock to the eternally elegant city of Vienna for its musums and palaces, cafes and churchs, and a night at one of the top opera houses in Europe.  With a few extra days, you could get your Sound of Music on in Salzburg, the baroque city ringed by castles and cliffs where Mozart was born (and the classic movie musical took place), and visit lovely little Innsbruck, high in the Tyrolean Alps.'),
(9, 'Canadian Religious Places', 700000, 'Canada is more like a multi-cultural country. Christianity with Roman Catholics and Protestants are predominant in Canada as the main religion. Religious tours in Canada take you to sights of importance, which include St. Anneâ€™s Anglican Church, Frikirju Church and St. Norbert. Apart from Christianity, other religions like Hinduism, Buddhism, Islam and Sikhism too have gained grounds in the country. '),
(10, 'Christian Places in England', 1200000, 'The Catholic Church in England and Wales is part of the worldwide Roman Catholic Church in full communion with the Pope. Celtic Christianity, with some traditions different from those of Rome, was present in Roman Britain from the first century AD, but after the departure of the Roman legions was in retreat to Paganism. In 597 AD, the first authoritative papal mission, establishing a direct link from the Kingdom of Kent to the See of Rome and to the Benedictine form of monasticism, was carried into effect by Augustine of Canterbury.'),
(11, 'Christianity Places', 500000, 'Christ Church Cathedral in Nelson is a beautiful Anglican church located in the  upper Trafalgar Street. The first church was built in the year 1851 at a different place and it was named as Christ Church Cathedral in 1886. A new church was created at the present site in 1887 but it was not before 1965 when the construction of this church got completed. '),
(12, ' Best of India', 10000, 'The Indian subcontinent is home to a number of ancient monuments, scenic locales, beaches, World Heritage Sites and cultural attractions. The states of Rajasthan, Gujarat, Goa, Himachal Pradesh, Jammu and Kashmir and Uttarakhand are among the top places toured by domestic and international tourists, pilgrims, wildlife enthusiasts and historians.'),
(13, 'Best of England', 900000, 'The Heart of England is an iconic region, encompassing Oxford, the Cotswolds, Stratford-upon-Avon and Bath, a UNESCO World Heritage site. On this five-day journey, we will visit Oxford and Lacock, explore quaint Cotswold villages famous for their charming honey-coloured stone cottages with thatched roofs and explore traditional stately homes.'),
(14, 'Best of Canada', 700000, 'It is so big it is hard to get your head around sometimes so, by joining a Canada small group holiday and like-minded tourists, it takes the pressure off the organisation front. They are perfect if you want a short cut to Canada’s cultural and natural highlights, such as hiking in the Rockies, going on a polar bear expedition, or dog sledding in the Yukon. '),
(15, 'Best Places in Mumbai', 12000, 'Mumbai, the industrial capital of India is one of the most popular places to holiday in India. To get details on places around Mumbai along with reliable info on places to visit in Mumbai or places to visit near Mumbai, tourists should come to Mustseeindia.com. A leading online travel website, Mustseeindia.com is the best place to book holidays for best places around Mumbai for picnic. '),
(16, 'Best of Thailand', 400000, 'Bangkok was an amazing introduction to Thailand, especially considering how much we saw in our one full day there. I remember telling our guide Ngu that if my whole trip ended the next day, I would still think visiting Thailand had been worthwhile. Ngu provided us with a remarkably thorough explanation of the historical and religious backgrounds of Wat Arun, the Royal Palace, and the Royal Barges. Although our day was full of activity, we never felt overwhelmed or rushed. In fact, we still had energy to attend a Thai dance show that evening, which Ngu kindly arranged for us and escorted us to, on his own time.'),
(17, ' Best Events in Singapore', 80000, 'There are so many Special events in Singapore like New Year celebration, Deepavali celebration, Christmas celebration, Food Festivals, Modeling Competition, Singing Competition etc...Singapore is also a best tourist place in the World...'),
(18, 'Best Events in Germany', 600000, 'There are so many Special events in Germany like New Year celebration, Deepavali celebration, Christmas celebration, Food Festivals, Modeling Competition, Singing Competition etc...Germany is also a best tourist place in the World...'),
(19, 'Best Events in France', 600000, 'There are so many Special events in France like New Year celebration, Deepavali celebration, Christmas celebration, Food Festivals, Modeling Competition, Singing Competition etc...France is also a best tourist place in the World...'),
(20, 'Star Wars Wedding Ideas', 20000, 'Let''s be honest: a Star Wars wedding can be tricky. You want it to be over-the-top fun, but you also run the risk of making it feel like a kids'' party. We''re here to help! Ahead, check out everything you need , from starry invites to a lightsaber send-off , to keep your big day classy and memorable at the same time. May the wedding-planning force be with you. '),
(21, 'Christmas Party Themes  ', 100000, 'Hundreds of christmas Party Ideas, christmas party themes, Invitations, Decorations, Party Supplies & Favors Party can help you plan and deliver a great Christmas holiday party. We have a variety of Christmas party themes for every type celebration. Spend a few moments browsing through a variety of Christmas party themes until you find the theme that is right for your holiday celebration. '),
(22, 'Entertainment Themed Vacations', 100000, 'At My Tour we create custom designed entertainment themed vacation packages based on your specific interests making each trip unique. My Tour will give you an idea of the types of packages that could be possible for an entertainment-themed holiday.'),
(23, 'Best parks in Rajasthan', 3000, 'Rajasthan the Largest state of India, famous for its rich culture and heritage, also have rich flora and fauna, although the forest cover is very little compare to other Indian states. Ranthambore National park at Rajasthan is world famous for tigers, below is the list of important wildlife national parks in Rajasthan. '),
(24, 'Best parks in Kerala', 4000, 'Kerala the gods own country is famous for its backwater, beaches and scenic beauty and wildlife, wildlife in Kerala are indeed some of the most magnificent and varied found anywhere in the world. The Western Ghats, the natural mountain barriers of Kerala, bordering Tamil Nadu and Karnataka are home to the majority of Kerala''s wildlife, below is the list of some of the important wildlife national parks in Kerela. '),
(25, 'Best parks in India', 2000, 'There are over 80 national parks in India, spread all over the country. Some are larger and more accessible then others. Many people want to see the infamous tiger. The chance of spotting a tiger greatly depends on the size of the national park and the number of tigers, and is higher at some parks than others. '),
(27, 'Travel in Israel', 100000, 'Israel is a tiny country, it got cultural, culinary, architectural, historical and spiritual experiences of biblical proportions.\r\n\r\nIsrael is not somewhere you stop off at or drop by the Holy Land requires attention, commitment, devotion and an open mind and heart, regardless of whether you are Jewish, Christian, Hindu, Agnostic, Animist, Jedi or Rasta.');

-- --------------------------------------------------------

--
-- Table structure for table `vertical_frag_2`
--

CREATE TABLE `vertical_frag_2` (
  `Packageid` int(50) NOT NULL,
  `Name` varchar(200) NOT NULL,
  `Noofdays` int(50) NOT NULL,
  `Child` int(50) NOT NULL,
...
--
-- Dumping data for table `vertical_frag_2`
--

INSERT INTO `vertical_frag_2` (`Packageid`, `Name`, `Noofdays`, `Child`, `Adults`, `Statusfield`) VALUES
(11, 'Shavir', 6, 1, 2, 'Booked'),
(13, 'Nikhil', 2, 2, 2, 'Booked'),
(15, 'Rehan', 3, 3, 2, 'Pending'),
(2, 'Amit Bauriya', 5, 2, 1, 'Pending');
